...
2. Click the terminal icon <img class="common_img" src="../_static/media/chapter_7/section_2/media/image24.png"  /> in the system desktop to open a command-line window.
...
1. Click the desktop icon <img class="common_img" src="../_static/media/chapter_7/section_2/media/image24.png"  /> to open the terminal, and enter the command to launch the image annotation software.
...
1. Click the desktop icon <img class="common_img" src="../_static/media/chapter_7/section_2/media/image24.png"  /> to open a terminal, and enter the command.
...
2. Click the desktop icon <img class="common_img" src="../_static/media/chapter_7/section_2/media/image33.png"   /> to open a terminal.
...
1. Power on ROSpider and remotely connect to the system desktop via NoMachine. For instructions on connecting to the remote desktop, refer to **[1. ROSpider User Manual \ 4. Development Environment Setup]()**.
2. Click the desktop icon <img class="common_img" src="../_static/media/chapter_7/section_3/media/image3.png" /> to open the command line terminal.
...
<td>gun</td>
<td>Finger gun</td>
<td><img class="common_img" src="../_static/media/chapter_7/section_3/media/image7.jpeg"  /></td>
<td>Attack (attack)</td>
</tr>
<tr>
<td>hand_heart</td>
<td>Finger heart</td>
<td><img class="common_img" src="../_static/media/chapter_7/section_3/media/image8.jpeg"  /></td>
<td>Twist body (twist_l)</td>
</tr>
<tr>
<td>OK</td>
<td>OK</td>
<td><img class="common_img" src="../_static/media/chapter_7/section_3/media/image9.jpeg"  /></td>
<td>Wave left front leg to greet (wave)</td>
</tr>
<tr>
<td>fist</td>
<td>Fist</td>
<td><img class="common_img" src="../_static/media/chapter_7/section_3/media/image10.jpeg"  /></td>
<td>Lunge forward (forward_flutter)</td>
</tr>
</tbody>
</table>
