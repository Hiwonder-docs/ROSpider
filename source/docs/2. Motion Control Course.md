...
2. Double-click the icon <img src="../_static/media/chapter_2/section_1/image18.png" class="common_img" style="width:80px;"/> on the system desktop to open the PC software.
...
1. Power on the robot and connect it to the remote control software NoMachine. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://wiki.hiwonder.com/projects/ROSpider/en/latest/docs/1.%20ROSpider%20User%20Manual.html#development-environment-setup)** directory for remote connection.
2. Click the icon <img src="../_static/media/chapter_2/section_1/image89.png" class="common_img" style="width:60px;"/> in the system status bar to open the file manager.
...
3. Click the icon <img src="../_static/media/chapter_2/section_1/image129.png" class="common_img"/> in the manual bar.
...
6. Click the icon <img src="../_static/media/chapter_2/section_1/image129.png" class="common_img"/> in the manual bar and select the **Clap** action. The robot will execute the corresponding action.
...
1. Power on the robot and connect it to the remote control software NoMachine.
2. Click the icon <img src="../_static/media/chapter_2/section_2/image5.png" class="common_img" style="width:60px;"/> on the system desktop to open the command line terminal.
...
1. Power on the robot and connect it to the remote control software NoMachine.
2. Click the icon <img src="../_static/media/chapter_2/section_2/image5.png" class="common_img" style="width:2.21.px;"/> on the system desktop to open the command line terminal.
3. Enter the following command and press **Enter** to close the auto-start program.
