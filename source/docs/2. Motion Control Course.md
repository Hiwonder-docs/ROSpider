...
2. Click the icon <img src="../_static/media/chapter_2/section_1/image3.png" class="common_img" style="width:60px;"/> on the system desktop to open the command line terminal.
...
1. Start the hexapod robot and connect it to the remote control software NoMachine. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://drive.google.com/drive/folders/18o7y4ArbtcjvzoS_NZuUUEdmDrNqfb_f?usp=sharing)** directory for remote connection.
2. Double-click the icon <img src="../_static/media/chapter_2/section_1/image18.png" class="common" style="width:80px;"/> on the system desktop to open the PC software.
...
<img src="../_static/media/chapter_2/section_1/image21.png" class="common" style="width:900px;"/>
...
<img src="../_static/media/chapter_2/section_1/image25.png" class="common" style="width:900px;"/>
...
1. Power on the robot and connect it to the remote control software NoMachine. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://drive.google.com/drive/folders/18o7y4ArbtcjvzoS_NZuUUEdmDrNqfb_f?usp=sharing)** directory for remote connection.
2. Double-click the icon <img src="../_static/media/chapter_2/section_1/image18.png" class="common" style="width:80px;"/> on the system desktop to open the PC software.
3. To facilitate subsequent explanations, the legs of ROSpider are sorted as shown in the figure below:

<img src="../_static/media/chapter_2/section_1/image54.png" class="common" style="width:600px;"/>

4. Action 1: Click the **Reset servo** button in the deviation adjustment area to restore the robot to its initial posture.

<img src="../_static/media/chapter_2/section_1/image55.png" class="common" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_1/image56.png" class="common" style="width:500px;"/>

The specific parameters of the action can be viewed in the action list area.

<img src="../_static/media/chapter_2/section_1/image57.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image58.png" class="common" style="width:150px;"/>
...
<img src="../_static/media/chapter_2/section_1/image59.png" class="common" style="width:600px;"/>

8. Action 3: Make legs No. 2 and No. 5 of ROSpider swing forward.

<img src="../_static/media/chapter_2/section_1/image60.png" class="common" style="width:600px;"/>

9. Action 4: Make legs No. 2 and No. 5 of ROSpider touch the ground.

<img src="../_static/media/chapter_2/section_1/image61.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image62.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image63.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image64.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image65.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image66.png" class="common" style="width:600px;"/>

13. Action 8: Separate legs No. 1 and No. 6 of ROSpider.

<img src="../_static/media/chapter_2/section_1/image67.png" class="common" style="width:600px;"/>

14. Action 9: Make legs No. 1 and No. 6 of ROSpider close slightly again to clap.

<img src="../_static/media/chapter_2/section_1/image68.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image70.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image56.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image72.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image73.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image74.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image76.png" class="common" style="width:600px;"/>

All numerical parameters of this action group are shown in the table below:

<img src="../_static/media/chapter_2/section_1/image77.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image78.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image79.png" class="common" style="width:600px;"/>

### 2.12.3 Action Group Invocation

1. Open the PC software and click **Action list**.

<img src="../_static/media/chapter_2/section_1/image80.png" class="common" style="width:600px;"/>

2. Select the name of the action group to be invoked.

<img src="../_static/media/chapter_2/section_1/image81.png" class="common" style="width:600px;"/>

3. After selection, click **Run action**.

<img src="../_static/media/chapter_2/section_1/image82.png" class="common" style="width:600px;"/>

### 2.12.4 Integrating Action Groups

1. After remotely connecting to the system, start the PC software.

<img src="../_static/media/chapter_2/section_1/image83.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image84.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image85.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image86.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image87.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image88.png" class="common" style="width:600px;"/>
...
To learn about the connection method of the app, refer to the related sections in directory **[1. ROSpider User Manual\1.3 Basic Robot Usage\1.3.3 App Installation and Connection](https://drive.google.com/drive/folders/18o7y4ArbtcjvzoS_NZuUUEdmDrNqfb_f?usp=sharing)**.
...
1. Power on the robot and connect it to the remote control software NoMachine. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://drive.google.com/drive/folders/18o7y4ArbtcjvzoS_NZuUUEdmDrNqfb_f?usp=sharing)** directory for remote connection.
2. Click the icon <img src="../_static/media/chapter_2/section_1/image89.png" class="common" style="width:60px;"/> in the system status bar to open the file manager.
...
<img src="../_static/media/chapter_2/section_1/image90.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image91.png" class="common" style="width:600px;"/>

3. Click the icon <img src="../_static/media/chapter_2/section_1/image129.png" class="common"/> in the manual bar.

<img src="../_static/media/chapter_2/section_1/image92.png" class="common" style="width:600px;"/>

4. Click the **Add** button to add a custom action.

<img src="../_static/media/chapter_2/section_1/image93.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image94.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image95.png" class="common" style="width:600px;"/>
...
6. Click the icon <img src="../_static/media/chapter_2/section_1/image129.png" class="common"/> in the manual bar and select the **Clap** action. The robot will execute the corresponding action.

<img src="../_static/media/chapter_2/section_1/image92.png" class="common" style="width:600px;"/>

<img src="../_static/media/chapter_2/section_1/image96.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image97.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image100.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image101.png" class="common" style="width:600px;"/>

### 2.14.3 Interface Description

<img src="../_static/media/chapter_2/section_1/image102.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image113.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image114.png" class="common" />

<img src="../_static/media/chapter_2/section_1/image115.png" class="common" style="width:500px;"/>

After each direction is successfully calibrated, the following prompt will appear:

<img src="../_static/media/chapter_2/section_1/image116.png" class="common" />
...
<img src="../_static/media/chapter_2/section_1/image117.png" class="common" />

<img src="../_static/media/chapter_2/section_1/image118.png" class="common" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_1/image119.png" class="common" />

<img src="../_static/media/chapter_2/section_1/image120.png" class="common" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_1/image121.png" class="common"/>

<img src="../_static/media/chapter_2/section_1/image122.png" class="common" style="width:500px;"/>
...
<img src="../_static/media/chapter_2/section_1/image123.png" class="common"/>

<img src="../_static/media/chapter_2/section_1/image124.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_1/image125.png" class="common"/>

<img src="../_static/media/chapter_2/section_1/image126.png" class="common" style="width:600px;"/>

12. The following prompt indicates that the calibration is complete.

<img src="../_static/media/chapter_2/section_1/image127.png" class="common"/>
...
<img src="../_static/media/chapter_2/section_1/image128.png" class="common" style="width:900px;"/>
...
<img src="../_static/media/chapter_2/section_2/image1.png" class="common" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image2.png" class="common" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image3.png" class="common" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image4.png" class="common" style="width:700px;"/>
...
1. Power on the robot and connect it to the remote control software NoMachine.
2. Click the icon <img src="../_static/media/chapter_2/section_2/image5.png" class="common" style="width:60px;"/> on the system desktop to open the command line terminal.
...
<img src="../_static/media/chapter_2/section_2/image7.png" class="common" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image8.png" class="common" style="width:700px;"/>
...
<img src="../_static/media/chapter_2/section_2/image9.png" class="common" style="width:600px;"/>
...
<img src="../_static/media/chapter_2/section_2/image10.png" class="common" style="width:600px;"/>
...
1. Power on the robot and connect it to the remote control software NoMachine.
2. Click the icon <img src="../_static/media/chapter_2/section_2/image5.png" class="common" style="width:2.21.px;"/> on the system desktop to open the command line terminal.
3. Enter the following command and press **Enter** to close the auto-start program.
