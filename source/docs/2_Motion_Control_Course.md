...
To learn about the connection method of the app, refer to the related sections in directory **[1. ROSpider User Manual\1.3 Basic Robot Usage\1.3.3 App Installation and Connection](https://wiki.hiwonder.com/projects/ROSpider/en/raspberry-pi-version/docs/1_ROSpider_User_Manual.html#app-installation-and-connection)**.
