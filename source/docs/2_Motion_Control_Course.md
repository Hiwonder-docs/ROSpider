...
1. Start the ROSpider and connect it to the remote control software VNC.
2. Click the icon <img src="../_static/media/chapter_2/section_1/image3.png" style="width:60px;"/> on the system desktop to open the command line terminal.
3. Enter the command and press **Enter** to close the auto-start program.
...
1. Start the hexapod robot and connect it to the remote control software VNC. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://wiki.hiwonder.com/projects/ROSpider/en/latest/docs/1.%20ROSpider%20User%20Manual.html#development-environment-setup)** directory for remote connection.
...
1. Power on the robot and connect it to the remote control software VNC. Refer to the contents in the **[1. ROSpider User Manual\1.4 Development Environment Setup](https://wiki.hiwonder.com/projects/ROSpider/en/latest/docs/1.%20ROSpider%20User%20Manual.html#development-environment-setup)** directory for remote connection.
2. Double-click the icon <img src="../_static/media/chapter_2/section_1/image18.png" style="width:80px;"/> on the system desktop to open the PC software.
...
To learn about the connection method of the app, refer to the related sections in directory **[1. ROSpider User Manual\1.3 Basic Robot Usage\1.3.3 App Installation and Connection](https://wiki.hiwonder.com/projects/ROSpider/en/latest/docs/1.%20ROSpider%20User%20Manual.html#app-installation-and-connection)**.
