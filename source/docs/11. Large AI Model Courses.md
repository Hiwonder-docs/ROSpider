...
1. Click the icon <img class="common_img" src="../_static/media/chapter_11/section_3/media/image39.png"  /> on the left side of the system interface to start the command-line terminal. Enter the command and press **Enter** to stop the auto-start service.
...
1. Click the icon <img class="common_img" src="../_static/media/chapter_11/section_3/media/image47.png"  /> on the left side of the system interface to open a command-line terminal. Enter the command, and press **Enter** to stop the auto-start service.
...
1. Click the icon <img class="common_img" src="../_static/media/chapter_11/section_3/media/image47.png"  /> on the left side of the system interface to open a command-line terminal. Enter the command and press **Enter** to stop the app auto-start service:
